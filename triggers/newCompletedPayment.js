const perform = async (z, bundle) => {
  ...
  return payments.filter((p) => p.status === 'paid' || p.status === 'overpaid');
};

module.exports = {
  key: 'new_completed_payment',
  noun: 'Completed Payment',
  display: {
    label: 'New Completed Payment',
    description: 'Triggers when a payment is fully received and confirmed.',
  },
  operation: {
    perform,
    sample: {
    ...
    outputFields: [
      ...
      { key: 'chain', label: 'Blockchain', type: 'string' },
